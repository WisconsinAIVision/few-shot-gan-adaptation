...
#CUDA_VISIBLE_DEVICES=5,6 python train.py --ckpt ../stylegan2-pytorch/checkpoint/110000.pt --data_path /scratch/dkn16/lmdb_ada --exp z7_to_z8_v2 --size 64 --source_key 110000 --iter 115000
